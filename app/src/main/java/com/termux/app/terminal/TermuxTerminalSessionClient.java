...
public class TermuxTerminalSessionClient extends TermuxTerminalSessionClientBase {
    ...
    private DailyDriver dailyDriver;
    ...
    public void onTextChangedRecorded(@NonNull TerminalSession changedSession, TerminalEmulatorChangeRecorder changes) {
        ...
        if (mActivity.getCurrentSession() == changedSession && dailyDriver != null) dailyDriver.processUpdate();
    }

    public void setDailyDriver(DailyDriver driver) {
        dailyDriver = driver;
    }
